 ...
 * @author victo
 */
public class Nota_JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmpDataEmissao = new javax.swing.JTextField();
        ...
        cmpDataEmissao.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N

        cmpValor.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        paneFormLayout.setHorizontalGroup(
            ...
            .addGroup(paneFormLayout.createSequentialGroup()
                ...
                .addGroup(paneFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmpDataEmissao)
                    .addComponent(cmpValor, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(paneFormLayout.createSequentialGroup()
                        .addGroup(paneFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmpNumero, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        paneFormLayout.setVerticalGroup(
            ...
            .addGroup(paneFormLayout.createSequentialGroup()
                ...
                .addComponent(jLabel12)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmpDataEmissao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void SalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SalvarMouseClicked
        ...
        obj.setDataEmissao(cmpDataEmissao.getText());
        obj.setValor(Double.parseDouble(cmpValor.getText()));
    ...
    private void tableNotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableNotaMouseClicked
        if(tableNota.getSelectedRow() != -1){
            Nota obj = modelo.retornaObjeto(tableNota.getSelectedRow());
            cmpNumero.setText(String.valueOf(obj.getNumero()));
            cmpDataEmissao.setText(obj.getDataEmissao());
            cmpValor.setText(String.valueOf(obj.getValor()));
        }
    ...
    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        Nota obj = new
                        Nota(
                            cmpDataEmissao.getText(),
                            Double.parseDouble(cmpValor.getText())
                        );
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        ...
        obj = dao.pesquisar(Integer.parseInt(cod));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nota_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nota_JFrame().setVisible(true);
            }
        });
    }
    ...
    private void limpar(){
            cmpNumero.setText("");
            cmpDataEmissao.setText("");
            cmpValor.setText("");   
    }

    private void atualizarLista(NotaDAO dao){
    modelo.setDados(dao.retornaLista(Integer.parseInt(cmpNumero.getText())));
    modelo.fireTableDataChanged();  
    }
    NotaTableModel modelo = new NotaTableModel(); 
    ...
    private javax.swing.JTextField cmpDataEmissao;
