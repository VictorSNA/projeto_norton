 ...
 * @author victo
 */
public class Hospedagem_JFrame extends javax.swing.JFrame {

    /**
     * Creates new form Atendente_JFrame
     */
    public Hospedagem_JFrame() {
        initComponents();
        carregarLista();
    }
    ...
    private void menuItem1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuItem1MouseClicked
        Hospedagem_JFrame atendente = new Hospedagem_JFrame();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hospedagem_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hospedagem_JFrame().setVisible(true);
            }
        });
    }
