 ...
 * @author victo
 */
public class Relatorio_JFrame extends javax.swing.JFrame {

    /**
     * Creates new form Atendente_JFrame
     */
    public Relatorio_JFrame() {
        initComponents();
        carregarLista();
    }
    ...
    private void menuItem1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuItem1MouseClicked
        Relatorio_JFrame atendente = new Relatorio_JFrame();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Relatorio_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Relatorio_JFrame().setVisible(true);
            }
        });
    }
